        ...
        <div class="w-100 pt-120 pb-140 gray-bg position-relative">
            <div class="container">
                <div class="listing-top-bar d-flex flex-wrap align-items-center w-100">
                    <div class="row">
                        {{-- <div class="col-md-3 col-lg-3 col-sm-4 pb-2">
                            <div class="slc-wp">
                                <select name="dock_country" id="dock-country">
                        ...
                        <div class="col-md-3 col-lg-3 col-sm-4 pb-2">
                            <div class="slc-wp">
                                <select name="dock_state" id="dock-state">
                                    ...
                                    <option value="Florida (Central East / Space Coast)">Florida (Central East / Space
                                        Coast)</option>
                        ...
                        <div class="col-md-6 col-lg-6 col-sm-4 pb-2">
                            <div class="slc-wp">
                        ...
                        <div class="col-md-6 col-lg-6 col-sm-4 pb-2">
                            <div class="slc-wp">
                                <select name="list_type" id="list-type">
                                    <option value="" disabled selected>Select List Type</option>
                ...
                <div class="listing-layout mt-70 w-100">
                    ...
                    <div class="row">
                        <div class="col-md-10 col-sm-12 col-lg-10" id="filter-results">
                            <div class="row">
                                    ...
                                    <div class="col-md-5 col-sm-6 col-lg-5">
                                        <div class="list-post-box brd-rd5 overflow-hidden position-relative w-100">
                                            ...
                                            <div class="list-post-img overflow-hidden position-relative w-100">
                                                @if (!empty($img))
                                                    <img class="img-fluid w-100" src="{{ asset('images/' . $img[0]) }}"
                                                        alt="List Post Image 1" style="height: 30vh !important">
                                                @else
                                                    <img class="img-fluid w-100" src="{{ asset('images/defaul2.jpg') }}"
                                                        alt="List Post Image 1">
                                                @endif
                                                <span class="list-post-cat position-absolute "><a class="rounded-pill"
                                                        href="{{ route('dock.details', $dock->id) }}"
                                                        title="">{{ $dock->is_featured == 1 ? 'Featured' : 'Basic' }}</a></span>
                                            ...
                                            <div class="list-post-info w-100">
                                                <div class="list-post-inner w-100">
                                                    <div class="list-post-info-top d-flex flex-wrap justify-content-between">
                                                        <span class="list-post-date"><i
                                                                class="thm-clr far fa-clock"></i>{{ date('Y-m-d', strtotime($dock->created_at)) }}</span>
                                                    </div>
                                                    <h3 class="mb-0"><a href="{{ route('dock.details', $dock->id) }}"
                                                            title="">{{ $dock->name }}</a></h3>
                                                    <div
                                                        ...
                                                        <div class="list-post-author d-inline-flex align-items-center">
                                                            <img class="rounded-circle img-fluid"
                                                                src="{{ asset('front-end') }}/assets/images/resources/author-img1-1.jpg"
                                                                alt="Author Image 1">
                                                            <span>{{ ucfirst($dock->user->first_name) }}</span>
                                                        </div>
                                                        <span
                                                            class="rounded-pill bg-color1">${{ !empty($dock->price) ? $dock->price : $dock->price_for_rent }}</span>
                                                ...
                                                <ul class="list-post-meta mb-0 list-unstyled">
                                                    <li class="active"><i
                                                            class="thm-clr fas fa-map-marker-alt"></i><span>{{ ucfirst($dock->dock_state) }},
                                                            {{ ucfirst($dock->dock_country) }}</span></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-2 col-sm-2 col-lg-2">
                            ...
                            <iframe style="width:120px;height:240px;" marginwidth="0" marginheight="0" scrolling="no"
                                frameborder="0"
                                src="<?php echo $site_setting->dock_list_page_ad  ?>">
                            </iframe><br>
                            <iframe style="width:120px;height:240px;" marginwidth="0" marginheight="0" scrolling="no"
                                frameborder="0"
                                src="<?php echo $site_setting->dock_list_page_ad  ?>">
...
@section('scripts')
<script>
    $("#dock-country").change(function() {

        var country = $(this).val();
        $.ajax({
            type: "get",
            url: "{{ route('country.filter') }}",
            data: {
                'country': country,
            },
